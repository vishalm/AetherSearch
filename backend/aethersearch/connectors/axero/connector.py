...
from aethersearch.connectors.cross_connector_utils.miscellaneous_utils import process_in_batches
...
def _get_entities(
    ...
    while True:
        ...
        # for example, a doc that hasn't been read in by AetherSearch is updated and is now front of the list
