<!-- AETHERSEARCH_METADATA={"link": "https://github.com/aethersearch-dot-app/aethersearch/blob/main/backend/alembic/README.md"} -->

# Alembic DB Migrations

These files are for creating/updating the tables in the Relational DB (Postgres).
AetherSearch migrations use a generic single-database configuration with an async dbapi.

## To generate new migrations:

From aethersearch/backend, run:
