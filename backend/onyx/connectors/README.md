<!-- AETHERSEARCH_METADATA={"link": "https://github.com/aethersearch-dot-app/aethersearch/blob/main/backend/aethersearch/connectors/README.md"} -->

# Writing a new AetherSearch Connector

This README covers how to contribute a new Connector for AetherSearch. It includes an overview of the design, interfaces,
...
Refer to [interfaces.py](https://github.com/aethersearch-dot-app/aethersearch/blob/main/backend/aethersearch/connectors/interfaces.py)
and this first contributor created Pull Request for a new connector (Shoutout to Dan Brown):
[Reference Pull Request](https://github.com/aethersearch-dot-app/aethersearch/pull/139)

For implementing a Slim Connector, refer to the comments in this PR:
[Slim Connector PR](https://github.com/aethersearch-dot-app/aethersearch/pull/3303/files)
...
> Note: Be sure to set PYTHONPATH to aethersearch/backend before running the above main.
...
- Add a new type to
  [DocumentSource](https://github.com/aethersearch-dot-app/aethersearch/blob/main/backend/aethersearch/configs/constants.py)
- Add a mapping from DocumentSource (and optionally connector type) to the right connector class
  [here](https://github.com/aethersearch-dot-app/aethersearch/blob/main/backend/aethersearch/connectors/factory.py#L33)

#### Frontend Changes

- Add the new Connector definition to the `SOURCE_METADATA_MAP` [here](https://github.com/aethersearch-dot-app/aethersearch/blob/main/web/src/lib/sources.ts#L59).
- Add the definition for the new Form to the `connectorConfigs` object [here](https://github.com/aethersearch-dot-app/aethersearch/blob/main/web/src/lib/connectors/connectors.ts#L79).

#### Docs Changes

Create the new connector page (with guiding images!) with how to get the connector credentials and how to set up the
connector in AetherSearch. Then create a Pull Request in [https://github.com/aethersearch-dot-app/documentation](https://github.com/aethersearch-dot-app/documentation).
