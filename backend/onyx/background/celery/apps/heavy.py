...
from aethersearch.configs.constants import POSTGRES_CELERY_WORKER_HEAVY_APP_NAME
...
celery_app.config_from_object("aethersearch.background.celery.configs.heavy")
