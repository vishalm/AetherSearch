...
This thread was 4 emails long:
    admin@aethersearch-test.com -> test-group-1@aethersearch-test.com (conaining test_user_1 and test_user_2)
    test_user_1@aethersearch-test.com -> admin@aethersearch-test.com
    admin@aethersearch-test.com -> test_user_2@aethersearch-test.com + BCC: test_user_3@aethersearch-test.com
    test_user_3@aethersearch-test.com -> admin@aethersearch-test.com
"""
_THREAD_1_BY_ID: dict[str, dict[str, Any]] = {
    "192edefb315737c3": {
        "email": "admin@aethersearch-test.com",
        "sections_count": 4,
        "primary_owners": set(
            [
                "admin@aethersearch-test.com",
                "test_user_1@aethersearch-test.com",
                "test_user_3@aethersearch-test.com",
            ]
        ),
        "secondary_owners": set(
            [
                "test-group-1@aethersearch-test.com",
                "admin@aethersearch-test.com",
    ...
    "192edf020d2f5def": {
        "email": "test_user_1@aethersearch-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@aethersearch-test.com", "test_user_1@aethersearch-test.com"]),
        "secondary_owners": set(["test-group-1@aethersearch-test.com", "admin@aethersearch-test.com"]),
    },
    "192edf020ae90aab": {
        "email": "test_user_2@aethersearch-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@aethersearch-test.com"]),
        "secondary_owners": set(
            ["test-group-1@aethersearch-test.com", "test_user_2@aethersearch-test.com"]
        ),
    },
    "192edf18316015fa": {
        "email": "test_user_3@aethersearch-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@aethersearch-test.com", "test_user_3@aethersearch-test.com"]),
        "secondary_owners": set(
            [
                "admin@aethersearch-test.com",
                "test_user_2@aethersearch-test.com",
