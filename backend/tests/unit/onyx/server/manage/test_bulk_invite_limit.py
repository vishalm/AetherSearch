...
from aethersearch.server.manage.users import bulk_invite_users
from aethersearch.server.manage.users import remove_invited_user
...
@patch(
    "aethersearch.server.manage.users.get_session_with_shared_schema",
    new_callable=lambda: _make_shared_session_mock(next_total=6),
)
@patch("aethersearch.server.manage.users.enforce_invite_rate_limit")
@patch("aethersearch.server.manage.users.MULTI_TENANT", True)
@patch("aethersearch.server.manage.users.is_tenant_on_trial_fn", return_value=True)
@patch("aethersearch.server.manage.users.get_current_tenant_id", return_value="test_tenant")
@patch("aethersearch.server.manage.users.get_invited_users", return_value=[])
@patch("aethersearch.server.manage.users.get_all_users", return_value=[])
@patch("aethersearch.server.manage.users.enforce_seat_limit")
@patch("aethersearch.server.manage.users.NUM_FREE_TRIAL_USER_INVITES", 5)
def test_trial_tenant_cannot_exceed_invite_limit(*_mocks: None) -> None:
    """Post-upsert total of 6 exceeds cap=5 — must raise AetherSearchError."""
    emails = [f"user{i}@example.com" for i in range(6)]

    with pytest.raises(AetherSearchError) as exc_info:
        bulk_invite_users(emails=emails, current_user=MagicMock())

    assert exc_info.value.error_code == AetherSearchErrorCode.TRIAL_INVITE_LIMIT_EXCEEDED
...
@patch("aethersearch.server.manage.users.enforce_invite_rate_limit")
@patch("aethersearch.server.manage.users.get_redis_client")
@patch("aethersearch.server.manage.users.MULTI_TENANT", True)
@patch("aethersearch.server.manage.users.DEV_MODE", True)
@patch("aethersearch.server.manage.users.ENABLE_EMAIL_INVITES", False)
@patch("aethersearch.server.manage.users.is_tenant_on_trial_fn", return_value=True)
@patch("aethersearch.server.manage.users.get_current_tenant_id", return_value="test_tenant")
@patch("aethersearch.server.manage.users.get_invited_users", return_value=[])
@patch("aethersearch.server.manage.users.get_all_users", return_value=[])
@patch("aethersearch.server.manage.users.write_invited_users", return_value=3)
@patch("aethersearch.server.manage.users.enforce_seat_limit")
@patch("aethersearch.server.manage.users.NUM_FREE_TRIAL_USER_INVITES", 5)
@patch(
    "aethersearch.server.manage.users.fetch_ee_implementation_or_noop",
...
@patch("aethersearch.server.manage.users.get_session_with_shared_schema")
@patch("aethersearch.server.manage.users.enforce_invite_rate_limit")
@patch("aethersearch.server.manage.users.MULTI_TENANT", True)
@patch("aethersearch.server.manage.users.DEV_MODE", True)
@patch("aethersearch.server.manage.users.ENABLE_EMAIL_INVITES", False)
@patch("aethersearch.server.manage.users.is_tenant_on_trial_fn", return_value=False)
@patch("aethersearch.server.manage.users.get_current_tenant_id", return_value="test_tenant")
@patch("aethersearch.server.manage.users.get_invited_users", return_value=[])
@patch("aethersearch.server.manage.users.get_all_users", return_value=[])
@patch("aethersearch.server.manage.users.write_invited_users", return_value=3)
...
_COMMON_PATCHES = [
    patch("aethersearch.server.manage.users.MULTI_TENANT", False),
    patch("aethersearch.server.manage.users.get_current_tenant_id", return_value="test_tenant"),
    patch("aethersearch.server.manage.users.get_invited_users", return_value=[]),
    patch("aethersearch.server.manage.users.get_all_users", return_value=[]),
    patch("aethersearch.server.manage.users.write_invited_users", return_value=1),
    patch("aethersearch.server.manage.users.enforce_seat_limit"),
    patch("aethersearch.server.manage.users.enforce_invite_rate_limit"),
]
...
@_with_common_patches
@patch("aethersearch.server.manage.users.ENABLE_EMAIL_INVITES", True)
@patch("aethersearch.server.manage.users.EMAIL_CONFIGURED", False)
...
@_with_common_patches
@patch("aethersearch.server.manage.users.ENABLE_EMAIL_INVITES", True)
@patch("aethersearch.server.manage.users.EMAIL_CONFIGURED", True)
@patch("aethersearch.server.manage.users.send_user_email_invite")
...
@patch("aethersearch.server.manage.users.EMAIL_CONFIGURED", True)
@patch(
    "aethersearch.server.manage.users.send_user_email_invite",
...
@patch("aethersearch.server.manage.users.enforce_remove_invited_rate_limit")
@patch("aethersearch.server.manage.users.remove_user_from_invited_users", return_value=0)
@patch("aethersearch.server.manage.users.MULTI_TENANT", True)
@patch("aethersearch.server.manage.users.DEV_MODE", True)
@patch("aethersearch.server.manage.users.is_tenant_on_trial_fn", return_value=False)
@patch("aethersearch.server.manage.users.get_current_tenant_id", return_value="test_tenant")
