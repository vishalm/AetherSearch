...
class TestValidateNoVectorDbSettings:
    @patch("aethersearch.main.DISABLE_VECTOR_DB", False)
    def test_no_error_when_vector_db_enabled(self) -> None:
        from aethersearch.main import validate_no_vector_db_settings

        validate_no_vector_db_settings()

    @patch("aethersearch.main.DISABLE_VECTOR_DB", True)
    @patch("aethersearch.main.MULTI_TENANT", False)
    @patch("aethersearch.server.features.build.configs.ENABLE_CRAFT", False)
    ...
    @patch("aethersearch.main.DISABLE_VECTOR_DB", True)
    @patch("aethersearch.main.MULTI_TENANT", True)
    ...
    @patch("aethersearch.main.DISABLE_VECTOR_DB", True)
    @patch("aethersearch.main.MULTI_TENANT", False)
    @patch("aethersearch.server.features.build.configs.ENABLE_CRAFT", True)
