...
from aethersearch.server.metrics.metrics_server import _DEFAULT_PORTS
...
def reset_server_state() -> Iterator[None]:
    ...
    import aethersearch.server.metrics.metrics_server as mod
...
class TestStartMetricsServer:
    @patch("aethersearch.server.metrics.metrics_server.start_http_server")
