...
from ee.aethersearch.external_permissions.sharepoint.permission_utils import (
    _enumerate_ad_groups_paginated,
)
from ee.aethersearch.external_permissions.sharepoint.permission_utils import _is_public_item
from ee.aethersearch.external_permissions.sharepoint.permission_utils import (
    _iter_graph_collection,
)
from ee.aethersearch.external_permissions.sharepoint.permission_utils import _normalize_email
from ee.aethersearch.external_permissions.sharepoint.permission_utils import (
...
from ee.aethersearch.external_permissions.sharepoint.permission_utils import GroupsResult

MODULE = "ee.aethersearch.external_permissions.sharepoint.permission_utils"
