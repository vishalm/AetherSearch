...
# NOTE: the tests for client should be independent of the AetherSearch MCP server
# This means the port should probably stay to be 8010/not 8090 the AetherSearch MCP server port
# Use MOCK_MCP_SERVER_PORT to avoid conflicts with the real AetherSearch MCP server port (8090)
