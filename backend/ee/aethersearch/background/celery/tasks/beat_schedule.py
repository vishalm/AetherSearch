...
from ee.aethersearch.configs.app_configs import CHECK_TTL_MANAGEMENT_TASK_FREQUENCY_IN_HOURS
...
from aethersearch.background.celery.tasks.beat_schedule import generate_cloud_tasks
from aethersearch.background.celery.tasks.beat_schedule import (
...
ee_beat_task_templates: list[dict] = [
    {
        ...
        "task": AetherSearchCeleryTask.GENERATE_USAGE_REPORT_TASK,
    ...
    },
    {
        ...
        "task": AetherSearchCeleryTask.CHECK_TTL_MANAGEMENT_TASK,
    ...
    },
    {
        ...
        "task": AetherSearchCeleryTask.EXPORT_QUERY_HISTORY_CLEANUP_TASK,
    ...
    ee_tasks_to_schedule = [
        {
            ...
            "task": AetherSearchCeleryTask.HOOK_EXECUTION_LOG_CLEANUP_TASK,
