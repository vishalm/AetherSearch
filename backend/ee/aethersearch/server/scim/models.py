...
Admin API schemas are internal to AetherSearch and used for SCIM token management.
"""
...
class ScimUserResource(BaseModel):
    ...
    id: str | None = None  # AetherSearch's internal user ID, set on responses
...
class ScimGroupMember(BaseModel):
    ...
    or removing users from groups. ``value`` is the AetherSearch user ID.
    """
...
# ---------------------------------------------------------------------------
# Admin API Schemas (AetherSearch-internal, for SCIM token management)
# These are NOT part of the SCIM protocol. They power the AetherSearch admin UI
