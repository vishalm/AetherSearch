...
from ee.aethersearch.db.usage_export import get_all_usage_reports
from ee.aethersearch.db.usage_export import get_usage_report_data
...
def generate_report(
    ...
    client_app.send_task(
        AetherSearchCeleryTask.GENERATE_USAGE_REPORT_TASK,
        kwargs={
            "tenant_id": tenant_id,
