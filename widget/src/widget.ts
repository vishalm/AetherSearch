/**
 * AetherSearch Chat Widget - Main Component
...
@customElement("aethersearch-chat-widget")
export class AetherSearchChatWidget extends LitElement {
  ...
  private renderCitations(
    ...
    const limit = AetherSearchChatWidget.CITATIONS_COLLAPSED_COUNT;
...
declare global {
  interface HTMLElementTagNameMap {
    "aethersearch-chat-widget": AetherSearchChatWidget;
  }
}
