...
export const colors = css`
  :host {
    ...
    /* AetherSearch Brand Colors */
    --aethersearch-ink-100: #000000;
    --aethersearch-ink-95: #1c1c1c;

    /* Theme / Primary - Configurable via env vars */
    --theme-primary-06: var(--aethersearch-ink-100);
    --theme-primary-05: var(--aethersearch-ink-95);
