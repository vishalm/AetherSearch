...
export const AVAILABLE_MODELS: HostedEmbeddingModel[] = [
  ...
  },
  {
    ...
    normalize: true,
    description:
      "The smallest and fastest version of the E5 line of models. If you're running AetherSearch on a resource constrained system, then this may be a good choice.",
