...
export default function MCPAuthenticationModal({
  ...
  // Check if OAuth is enabled for the AetherSearch instance
                    ...
                    <div className="flex flex-col gap-4 px-2 py-2 bg-background-tint-00 rounded-12">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Text as="p" text03 secondaryBody>
                          ...
                          your AetherSearch instance with the server provider to obtain
                          these credentials first. Make sure to grant AetherSearch
