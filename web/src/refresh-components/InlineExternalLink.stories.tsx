...
export const Default: Story = {
  args: {
    href: "https://docs.aethersearch.app",
    children: "AetherSearch Documentation",
  },
};

export const CustomClassName: Story = {
  args: {
    href: "https://github.com/aethersearch-dot-app/aethersearch",
...
export const InContext: Story = {
  render: () => (
    <p className="font-main-content-body text-text-04">
      ...
      <InlineExternalLink href="https://docs.aethersearch.app">
        official documentation
      </InlineExternalLink>{" "}
      or check out the{" "}
      <InlineExternalLink href="https://github.com/aethersearch-dot-app/aethersearch">
        source code
      </InlineExternalLink>
      .
    </p>
