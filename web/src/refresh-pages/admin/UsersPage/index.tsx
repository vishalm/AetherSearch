    ...
    <SettingsLayouts.Root width="lg">
      ...
      >
        <MessageCard
          ...
          description="AetherSearch is transitioning to group-based permissions for more granular access control. Curator and Global Curator roles will be replaced by configurable group permissions. We recommend reviewing current role assignments to ensure a smooth transition."
          rightChildren={
            <Button
