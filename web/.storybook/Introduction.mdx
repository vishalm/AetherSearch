...
A living catalog for browsing, testing, and documenting AetherSearch UI components in isolation.

---

## What is this?

This Storybook contains interactive examples of every reusable UI component in the AetherSearch frontend. Each component has a dedicated page with:
...
Production builds deploy to [aethersearch-storybook.vercel.app](https://aethersearch-storybook.vercel.app) automatically when PRs touching component files merge to `main`.
