# AetherSearch Desktop

A lightweight macOS desktop application for [AetherSearch Cloud](https://cloud.aethersearch.app).
...
- 🔗 **Multi-window** - Open multiple AetherSearch windows
...
The app defaults to `https://cloud.aethersearch.app` but supports any AetherSearch instance.

**Config file location:**

- macOS: `~/Library/Application Support/app.aethersearch.desktop/config.json`
- Linux: `~/.config/app.aethersearch.desktop/config.json`
- Windows: `%APPDATA%/app.aethersearch.desktop/config.json`
...
```json
{
  "server_url": "https://your-aethersearch-instance.company.com",
  "window_title": "AetherSearch"
}
```
...
```bash
# macOS
open -t ~/Library/Application\ Support/app.aethersearch.desktop/config.json

# Or use any editor
code ~/Library/Application\ Support/app.aethersearch.desktop/config.json
```
...
```json
{
  "app": {
    "windows": [
      {
        "url": "https://your-aethersearch-instance.com"
      }
    ]
  }
}
...
Make sure you have an internet connection. The app loads content from `cloud.aethersearch.app`.
...
2. Sign the app: `codesign --deep --force --sign "Developer ID" target/release/bundle/macos/AetherSearch.app`
