...
func newConfigureCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Set up the AetherSearch CLI with your server URL and API key.
...
Use --dry-run to test the connection without saving the configuration.`,
  ...
  aethersearch-cli configure --server-url https://my-aethersearch.com --api-key sk-... --dry-run`,
	...
	cmd.Flags().StringVar(&serverURL, "server-url", "", "AetherSearch server URL (e.g., https://cloud.aethersearch.app)")
