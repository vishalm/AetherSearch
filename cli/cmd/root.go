// Package cmd implements Cobra CLI commands for the AetherSearch CLI.
package cmd
...
import (
	...
	"github.com/aethersearch-dot-app/aethersearch/cli/internal/version"
...
func Execute() error {
	...
	rootCmd := &cobra.Command{
		Use:   "aethersearch-cli",
		Short: "Terminal UI for chatting with AetherSearch",
		Long:  "AetherSearch CLI — a terminal interface for chatting with your AetherSearch agent.",
