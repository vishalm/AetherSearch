# Welcome to AetherSearch

To set up AetherSearch there are several options, AetherSearch supports the following for deployment:
...
**For more detailed guides, please refer to the documentation: https://docs.aethersearch.app/deployment/overview**
...
The script will create an aethersearch_data directory, all necessary files for the deployment will be stored in
...
AetherSearch maintains backwards compatibility across all minor versions following SemVer. If following the install.sh script (or through Docker Compose), you can
...
IMAGE_TAG is the version of AetherSearch to run. It is recommended to leave it as latest to get all updates with each redeployment.
